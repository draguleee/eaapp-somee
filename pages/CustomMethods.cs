...
namespace tests
{
    public static class CustomMethods
    {
        ...
        public static void SendKeys(IWebElement locator, string value)
        {
        ...
        public static void SelectDropdown(IWebElement locator, string text, string attribute)
        {
        ...
        public static void MultiSelect(IWebElement locator, string[] values, string attribute)
        {
            var selectElement = new SelectElement(locator);
        ...
        /// <param name="locator"></param>
        /// <returns></returns>
        public static List<string> GetSelectedOptions(IWebElement locator)
        {
